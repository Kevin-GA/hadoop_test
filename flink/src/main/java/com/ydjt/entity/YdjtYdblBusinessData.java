...
/**
 * 
 * @TableName YDJT_YDBL_BUSINESS_DATA
 */
@TableName(value ="YDJT_YDBL_BUSINESS_DATA")
public class YdjtYdblBusinessData implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        YdjtYdblBusinessData other = (YdjtYdblBusinessData) that;
